  ...
  blocks: [
    {
      id: "m_welcome",
      type: "welcome",
      title: "This is a real question flow, not a screenshot.",
      description: "Three steps · try your keyboard",
      buttonLabel: "Try it",
    },
    {
      id: "m_use",
    ...
    },
    {
      id: "m_email",
      type: "short_text",
      title: "Where should we send your first form?",
      required: false,
    ...
    },
    {
      id: "m_thanks",
      type: "thank_you",
      title: "See? One question at a time.",
      description: "Imagine your own questions here — with your branding.",
    },
  ],
  logic: [],
};
